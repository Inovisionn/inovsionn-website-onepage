...
const RadialPulseLoader = ({
    size = 150,
    color = '#3B82F6', // Changed default color to accent color of Inovisionn
    text = 'Integneren...',
    showText = true
}) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-4">
            ...
            {showText && <div className="text-xs font-data text-accent tracking-widest uppercase animate-pulse">{text}</div>}
        </div>
    );
};
